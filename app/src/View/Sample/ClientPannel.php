						...
						<table id="clientTable" class="pannel__content-table tablesorter">
							<thead>
								<tr>
									...
									<th class="header">Adresse 2</th>
									<th class="header">Adresse 3</th>
							...
							<tbody id="clientTableBody">
								<tr>
									<td colspan="11" class="pannel__content-table-loading">Chargement des clients...</td>
								</tr>
							</tbody>
						</table>
					</div>
