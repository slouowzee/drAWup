<section class="pannel__content">
			<div class="pannel__add-client-header">
				...
				<h2 class="pannel__add-client-title">Ajout d'un article</h2>
			</div>

			<form id="addArticleForm" class="pannel__add-client-form" aria-label="Formulaire d'ajout d'article">
			...
			<div class="pannel__add-client-footer">
				<button type="button" id="article-save" class="pannel__add-client-save-button"><i class="fas fa-save"></i> Enregistrer l'article</button>
			</div>
			...
			<script type="module" src="<?= BASE_URL . '/src/View/Public/JS/addArticle.js'?>"></script>
		</section>
