<section class="pannel__content">
			...
			<form id="editClientForm" class="pannel__edit-client-form" aria-label="Formulaire d'édition client">
				<div class="pannel__edit-client-form-grid">
					...
					<div class="form-group">
						<label for="client-adresse2"><i class="fas fa-map-marker-alt"></i> Adresse 2</label>
						<input type="text" id="client-adresse2" name="client_adresse2" placeholder="Adresse 2 du client" class="form-control" autocomplete="address-line2">
					</div>

					<div class="form-group">
						<label for="client-adresse3"><i class="fas fa-map-marker-alt"></i> Adresse 3</label>
						<input type="text" id="client-adresse3" name="client_adresse3" placeholder="Adresse 3 du client" class="form-control" autocomplete="address-line3">
					</div>
			...
			<div class="pannel__edit-client-footer">
				<button id="client-save" class="pannel__edit-client-save-button" aria-label="Enregistrer les modifications">
					<i class="fas fa-save"></i> Enregistrer
				</button>
			</div>
		</section>
		<script type="module" src="<?= BASE_URL . '/src/View/Public/JS/editClient.js'?>"></script>
