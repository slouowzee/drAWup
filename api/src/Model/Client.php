	...
	class Client {
		...
		public function addNewClient($client) {
			try {
				...
				$sql = "INSERT INTO client (NOMCLI, PRENOMCLI, ADRCLI1, ADRCLI2, ADRCLI3, VILLECLI, CPCLI, LIGNECONTACTCLI";
				$sql .= $hasLogo ? ", LOGOCLI) " : ") ";
				$sql .= "VALUES (:lastName, :firstName, :address, :address2, :address3, :city, :postalCode, :contactLine";
				$sql .= $hasLogo ? ", :logo)" : ")";
				...
				$stmt->bindParam(':address2', $client['address2'], PDO::PARAM_STR);
				$stmt->bindParam(':address3', $client['address3'], PDO::PARAM_STR);
		...
		public function updateClientByID($clientData) {
			try {
				...
				$stmt->bindValue(':adresse2', $clientData['adresse2'], PDO::PARAM_STR);
				$stmt->bindValue(':adresse3', $clientData['adresse3'], PDO::PARAM_STR);
